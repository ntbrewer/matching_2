...
MtasProcessor::MtasProcessor() :
  EventProcessor(), mtasSummary(NULL), siliSummary(NULL), thermSummary(NULL), logiSummary(NULL), refmodSummary(NULL) //Goetz added refmodSummary subtype
{
  firstTime = -1.;
    name = "mtas";
...
void MtasProcessor::DeclarePlots(void) const
{
	...
	DeclareHistogram1D(MTAS_POSITION_ENERGY+200, EnergyBins, "Total Mtas");
      	...
      	DeclareHistogram1D(MTAS_POSITION_ENERGY+213, EnergyBins, "Total Central+Plug");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+215, EnergyBins, "Total Plug");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+216, EnergyBins, "Total Central Only");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+217, EnergyBins, "Total Plug Only");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+218, EnergyBins, "Total Central+Plug Only");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+219, EnergyBins, "Total Central+Plug Crosstalk Only");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+220, EnergyBins, "Total Inner");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+226, EnergyBins, "Total Inner Only");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+230, EnergyBins, "Total Middle");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+236, EnergyBins, "Total Middle Only");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+240, EnergyBins, "Total Outer");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+246, EnergyBins, "Total Outer Only");
	...
	//beta gated TAS spectras
      	...
      	DeclareHistogram1D(MTAS_POSITION_ENERGY+313, EnergyBins, "Total Central+Plug, Beta-gated");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+315, EnergyBins, "Total Plug, Beta-gated");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+316, EnergyBins, "Total Central Only, Beta-gated");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+317, EnergyBins, "Total Plug Only, Beta-gated");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+318, EnergyBins, "Total Central+Plug Only, Beta-gated");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+319, EnergyBins, "Total Central+Plug Crosstalk Only");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+320, EnergyBins, "Total Inner, Beta-gated");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+326, EnergyBins, "Total Inner Only, Beta-gated");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+330, EnergyBins, "Total Middle, Beta-gated");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+336, EnergyBins, "Total Middle Only, Beta-gated");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+340, EnergyBins, "Total Outer, Beta-gated");
       	DeclareHistogram1D(MTAS_POSITION_ENERGY+346, EnergyBins, "Total Outer Only, Beta-gated");
...
//	DeclareHistogram1D(MTAS_POSITION_ENERGY+307, EnergyBins, "Scalar Rate (s) Beta Gated Central");
	...
	//2D spectras E vs. T for drift monitoring. 
	DeclareHistogram2D(MTAS_POSITION_ENERGY+250, SA, SA, "MTAS Plug / 10  vs C / 10");
	DeclareHistogram2D(MTAS_POSITION_ENERGY+251, SA, SA, "MTAS T / 10 vs Plug / 10 C and Plug only");
	DeclareHistogram2D(MTAS_POSITION_ENERGY+252, SA, SA, "MTAS T / 10 vs C / 10 C and Plug only");

	DeclareHistogram2D(MTAS_POSITION_ENERGY+380, SA, SB, "MTAS T/10 vs. Run Time (min) ");
	DeclareHistogram2D(MTAS_POSITION_ENERGY+381, SA, SB, "MTAS C/10 vs. Run Time (min) ");
	DeclareHistogram2D(MTAS_POSITION_ENERGY+382, SA, SB, "MTAS I/10 vs. Run Time (min) ");
	DeclareHistogram2D(MTAS_POSITION_ENERGY+383, SA, SB, "MTAS M/10 vs. Run Time (min) ");
	DeclareHistogram2D(MTAS_POSITION_ENERGY+384, SA, SB, "MTAS O/10 vs. Run Time (min) ");
	DeclareHistogram2D(MTAS_POSITION_ENERGY+385, SA, SB, "MTAS P/10 vs. Run Time (min) ");
	//2D spectras
	DeclareHistogram2D(MTAS_POSITION_ENERGY+347, SA, SA, "MTAS Plug / 10  vs C + P/ 10");
	DeclareHistogram2D(MTAS_POSITION_ENERGY+348, SA, SA, "MTAS Center / 10  vs C + P / 10");
	DeclareHistogram2D(MTAS_POSITION_ENERGY+349, SA, SA, "MTAS / 10  vs Plug / 10");
	...
	*/
	...
	for(int i=0; i<24; i++)
	{
		DeclareHistogram1D(MTAS_POSITION_ENERGY+100+i, EnergyBins, "Sum F+B, Ring-gated"); 
	}
	for(int i=0; i<48; i++)
	{
		DeclareHistogram1D(MTAS_POSITION_ENERGY+150+i, EnergyBins, "Raw Energy, Ring-gated"); 
	}
    //Neutron stuff
 ...
 */
	DeclareHistogram1D(MTAS_POSITION_ENERGY+480, EnergyBins, "APD with 511 in Plug");
	DeclareHistogram1D(MTAS_POSITION_ENERGY+481, EnergyBins, "APD with 511 in Center");
	DeclareHistogram1D(MTAS_POSITION_ENERGY+482, EnergyBins, "APD with 511 in Plug and Center");

	/*DeclareHistogram2D(MTAS_POSITION_ENERGY+483, S9,SB, "Traces with Sat");
	DeclareHistogram2D(MTAS_POSITION_ENERGY+484, S9,SB, "Traces w/o Sat and Max Pos. Delayed");
	DeclareHistogram2D(MTAS_POSITION_ENERGY+485, S9,SB, "Traces w/o Sat and either High energy or Pileup");
	DeclareHistogram2D(MTAS_POSITION_ENERGY+486, S9,SB, "Other Traces (std. dev. cut)");
  */
}
...
bool MtasProcessor::Process(RawEvent &event)
{
  ...
  if (thermSummary == NULL) 
    thermSummary = event.GetSummary("therm");

	vector<ChanEvent*> mtasList= mtasSummary->GetList();
	vector<ChanEvent*> siliList= siliSummary->GetList();
	vector<ChanEvent*> thermList= thermSummary->GetList();
...
//spectras 
	...
	vector <double> centerMtasRaw (12,-1);
  vector <double> innerMtasRaw (12,-1);
	vector <double> middleMtasRaw(12,-1);
	vector <double> outerMtasRaw (12,-1);
    // 0-5 Central, 6-11 Inner, 12-17 Middle, 18-23 Outer
	vector <double> sumFrontBackEnergy(48,0);// Made arbitrartilty big to handle plug
    //BCR, arbitrartilty is my new favorite word. - NTB
	int nrOfCentralPMT = 0;
	double theSmallestCEnergy = 60000;
	bool isCenter=false, isPlug=false, isInner=false, isMiddle=false, isOuter=false;
            ...
            mtasMapIt != mtasMap.end(); mtasMapIt++)
	{
		...
		if((*mtasMapIt).first[0] == 'C')
		{
		  ...
		  centerMtasRaw.at(location-1) =  (*mtasMapIt).second.energy;
		  nrOfCentralPMT++;
		...
		else if((*mtasMapIt).first[0] == 'I')
		{
		  ...
		  innerMtasRaw.at(location-1-12) =  (*mtasMapIt).second.energy;
		...
		else if((*mtasMapIt).first[0] == 'M')
		{
		  ...
		  totalMtasEnergy.at(0) += signalEnergy/2.;
 		  middleMtasRaw.at(location-1-24) =  (*mtasMapIt).second.energy;		
		...
		else if((*mtasMapIt).first[0] == 'O')
		{
		  ...
		  totalMtasEnergy.at(0) += signalEnergy/2.;
 		  outerMtasRaw.at(location-1-36) =  (*mtasMapIt).second.energy;		
		...
		else if((*mtasMapIt).first[0] == 'P')
		{
		  isPlug = true;
		  totalMtasEnergy.at(5) += signalEnergy;
		  totalMtasEnergy.at(0) += signalEnergy;
		}
...
//		}
  ...
  bool centerOnly = (!isPlug && isCenter && !isInner && !isMiddle && !isOuter); 
  bool plugOnly = (isPlug && !isCenter && !isInner && !isMiddle && !isOuter);
  bool innerOnly = (!isPlug && !isCenter && isInner && !isMiddle && !isOuter);
  bool middleOnly = (!isPlug && !isCenter && !isInner && isMiddle && !isOuter);
  bool outerOnly = (!isPlug && !isCenter && !isInner && !isMiddle && isOuter);
  bool centerAndPlugOnly = (isPlug && isCenter && !isInner && !isMiddle && !isOuter);
  
	static double TemperatureMV =0.;
	//for(vector<ChanEvent*>::const_iterator thermIt = thermList.begin(); thermIt != thermList.end(); thermIt++)
	//{
	if (!thermList.empty())
	{
	    const ChanEvent *thermEv = thermSummary->GetMaxEvent();
      TemperatureMV = thermEv->GetTemperature();
  }
	//cout << TemperatureMV <<endl;  
	  //Betas (APD) Triggering
...
//     Matt** Loop over all APD. Sili means APD
	  ...
	  if(siliMap.size()>0)
	  {
            ...
            maxSiliconSignal = (siliEv->GetEnergy())/2.;//Jan 03 2011 Ola K
            siliSaturated = siliEv->IsSaturated();
            //if (siliSaturated) cout << maxSiliconSignal << endl;
           /* if ( !siliEv->GetTraceRef().empty() ) 
            {
                ...
                const vector <int> &siliTrace = siliEv->GetTraceRef();
                if (siliSaturated)
                {
                   	
                   	for(unsigned int i = 0; i < siliTrace.size(); i++)
                	 	{
                   			plot(MTAS_POSITION_ENERGY+483,i,traceCounter[0],siliTrace[i]);
	                  }
                    if (siliEv->IsPileup())  plot(MTAS_POSITION_ENERGY+483,siliTrace.size()+4,traceCounter[0]);                   
                   	traceCounter[0]++;
                } else if ( std::distance(siliTrace.begin(),std::max_element(siliTrace.begin(),siliTrace.end())) > 58 )//(siliEv->IsPileup())
                {
                   	for(unsigned int i = 0; i < siliTrace.size(); i++)
                	 	{
                        plot(MTAS_POSITION_ENERGY+484,i,traceCounter[2],siliTrace[i]);
                    }
                    if (siliEv->IsPileup())  plot(MTAS_POSITION_ENERGY+484,siliTrace.size()+4,traceCounter[2]);
                    traceCounter[2]++;
                } else if (*std::max_element(siliTrace.begin(),siliTrace.end())>4000 || siliEv->IsPileup())
                {
                    for(unsigned int i = 0; i < siliTrace.size(); i++)
                	 	{
                        plot(MTAS_POSITION_ENERGY+485,i,traceCounter[1],siliTrace[i]);
                    }
                    if (siliEv->IsPileup())  plot(MTAS_POSITION_ENERGY+485,siliTrace.size()+4,traceCounter[1]);
                    traceCounter[1]++;                    
                } else if (maxSiliconSignal > 1 && maxSiliconSignal < 2000 && siliEv->GetStdDevBaseline() < 30)
                {
                   // cout << traceCounter[3] <<" " <<  siliEv->GetStdDevBaseline() <<" " << tAvgBaseline << endl;
                   	for(unsigned int i = 0; i < siliTrace.size(); i++)
                	 	{
                        plot(MTAS_POSITION_ENERGY+486,i,traceCounter[3],siliTrace[i]);
                    }
                    traceCounter[3]++;
                } //End trace check. 
            }*/
#ifdef BLINDED
            /*if(maxSiliconSignal > -10.0 && maxSiliconSignal < 7000.0 && totalMtasEnergy.at(0) < 20.) 
            {
                isBetaSignal = false;
            } else {
                isBetaSignal = true;            
            ...
            if(maxSiliconSignal > -10.0 && maxSiliconSignal < 7000.0 && totalMtasEnergy.at(0) < 20.) 
            {
							EndProcess();
							return true;
            } else if(maxSiliconSignal > 0.0 || siliSaturated) 
            {
                isBetaSignal = true;            
                betaTime = siliEv->GetTime() * pixie::clockInSeconds;
          		if (firstBetaTime == -1.0) 
	...
	for(unsigned int i=0; i<sumFrontBackEnergy.size(); i++)
	{
		...
		// Plot plug energies
		//if( totalMtasEnergy.at(5) > 0.0 )
		//{
		plot(MTAS_POSITION_ENERGY+213, totalMtasEnergy.at(5)+totalMtasEnergy.at(1) );
		if( isBetaSignal ) plot(MTAS_POSITION_ENERGY+313, totalMtasEnergy.at(5)+totalMtasEnergy.at(1));

		plot(MTAS_POSITION_ENERGY+215, totalMtasEnergy.at(5));
		if( isBetaSignal ) plot(MTAS_POSITION_ENERGY+315, totalMtasEnergy.at(5));
		
		if (innerOnly)
		{
		  for (unsigned int i=0; i<12; i++) 
		  {
		      plot(MTAS_POSITION_ENERGY+150+i+12, innerMtasRaw.at(i));
		  }
		  plot(MTAS_POSITION_ENERGY+226, totalMtasEnergy.at(2));
		  if( isBetaSignal ) plot(MTAS_POSITION_ENERGY+326, totalMtasEnergy.at(2));
	    }
		if (middleOnly)
		{
		  for (unsigned int i=0; i<12; i++) 
		  {
		      plot(MTAS_POSITION_ENERGY+150+i+24, middleMtasRaw.at(i));
		  }
		  plot(MTAS_POSITION_ENERGY+236, totalMtasEnergy.at(3));
		  if( isBetaSignal ) plot(MTAS_POSITION_ENERGY+336, totalMtasEnergy.at(3));
	    }
		if (outerOnly)
		{
		  for (unsigned int i=0; i<12; i++) 
		  {
		      plot(MTAS_POSITION_ENERGY+150+i+36, outerMtasRaw.at(i));
		  }
		  plot(MTAS_POSITION_ENERGY+246, totalMtasEnergy.at(4));
		  if( isBetaSignal ) plot(MTAS_POSITION_ENERGY+346, totalMtasEnergy.at(4));
	    }
		if (centerOnly)
		{
		  plot(MTAS_POSITION_ENERGY+216, totalMtasEnergy.at(1));
		  for (unsigned int i=0; i<12; i++) 
		  {
		      plot(MTAS_POSITION_ENERGY+150+i, centerMtasRaw.at(i));
		  }
  		if( isBetaSignal ) plot(MTAS_POSITION_ENERGY+316, totalMtasEnergy.at(1));
	  }
	  if (plugOnly)	
	  {
  		plot(MTAS_POSITION_ENERGY+217, totalMtasEnergy.at(5));
	  	if( isBetaSignal ) plot(MTAS_POSITION_ENERGY+317, totalMtasEnergy.at(5));
		}
		if (centerAndPlugOnly)
		{
  		plot(MTAS_POSITION_ENERGY+218, totalMtasEnergy.at(1)+totalMtasEnergy.at(5));
	  	if( isBetaSignal ) plot(MTAS_POSITION_ENERGY+318, totalMtasEnergy.at(1)+totalMtasEnergy.at(5));

			if( totalMtasEnergy.at(1) > 0.0 && totalMtasEnergy.at(5) > 0.0 )
			{// Only cross talk between C & P with none in other parts of MTAS in these plots
	  		plot(MTAS_POSITION_ENERGY+219, totalMtasEnergy.at(1)+totalMtasEnergy.at(5));
		  	if( isBetaSignal ) plot(MTAS_POSITION_ENERGY+319, totalMtasEnergy.at(1)+totalMtasEnergy.at(5));
	  	}

			plot(MTAS_POSITION_ENERGY+251, totalMtasEnergy.at(0) / 10.0, totalMtasEnergy.at(5) / 10.0);
			plot(MTAS_POSITION_ENERGY+252, totalMtasEnergy.at(0) / 10.0, totalMtasEnergy.at(1) / 10.0);
		}
    //Drift watching plots TCIMOP. PlotIds 3380-3385 no beta gated version
    plot(MTAS_POSITION_ENERGY+380, totalMtasEnergy.at(0)/10.0, (actualTime-firstTime)/60.0);
    plot(MTAS_POSITION_ENERGY+381, totalMtasEnergy.at(1)/10.0, (actualTime-firstTime)/60.0);
    plot(MTAS_POSITION_ENERGY+382, totalMtasEnergy.at(2)/10.0, (actualTime-firstTime)/60.0);
    plot(MTAS_POSITION_ENERGY+383, totalMtasEnergy.at(3)/10.0, (actualTime-firstTime)/60.0);
    plot(MTAS_POSITION_ENERGY+384, totalMtasEnergy.at(4)/10.0, (actualTime-firstTime)/60.0);
    plot(MTAS_POSITION_ENERGY+385, totalMtasEnergy.at(5)/10.0, (actualTime-firstTime)/60.0);
            
		plot(MTAS_POSITION_ENERGY+250, totalMtasEnergy.at(1) / 10.0, totalMtasEnergy.at(5) / 10.0);


		//3225, 3235, 3245 - sum spectra, no B-gated and 3305, 3325, 3335, 3345, B-gated 
		for(int i=0; i<6; i++)
		{
			if (centerOnly) plot(MTAS_POSITION_ENERGY+100+i, sumFrontBackEnergy.at(i));//F+BC (doesn't make sense)
			plot(MTAS_POSITION_ENERGY+225, sumFrontBackEnergy.at(i+6));//Sum I
			if (innerOnly) plot(MTAS_POSITION_ENERGY+100+i+6, sumFrontBackEnergy.at(i+6));//F+BI
			plot(MTAS_POSITION_ENERGY+235, sumFrontBackEnergy.at(i+12));//Sum M
  		if (middleOnly) plot(MTAS_POSITION_ENERGY+100+i+12, sumFrontBackEnergy.at(i+12));//F+BM
			plot(MTAS_POSITION_ENERGY+245, sumFrontBackEnergy.at(i+18));//Sum O
			if (outerOnly) plot(MTAS_POSITION_ENERGY+100+i+18, sumFrontBackEnergy.at(i+18)); //F+BO     
		...
		if(isBetaSignal) 
		{
			...
			//3350 mtas tot vs I, M, O, B-gated, 3349 is the plug vs total,
			// 3347 is center versus center + plug, 3348 is plug versus center + plug
			plot(MTAS_POSITION_ENERGY+347, ( totalMtasEnergy.at(1) + 
			totalMtasEnergy.at(5) ) / 10.0, totalMtasEnergy.at(1) / 10.0);

			plot(MTAS_POSITION_ENERGY+348, ( totalMtasEnergy.at(1) + 
			totalMtasEnergy.at(5) ) / 10.0, totalMtasEnergy.at(5) / 10.0);

			plot(MTAS_POSITION_ENERGY+349, totalMtasEnergy.at(0) / 10.0,
			totalMtasEnergy.at(5) / 10.0);
			...
			// Hard cuts that depend on the calibration
			if( totalMtasEnergy.at(0) > 1000.0 && totalMtasEnergy.at(0) < 1040.0 )
			{
	 			if( totalMtasEnergy.at(5) > 490.0 && totalMtasEnergy.at(5) < 540.0 )
				{	
					plot(MTAS_POSITION_ENERGY+480, maxSiliconSignal );
					if( totalMtasEnergy.at(1) > 495.0 && totalMtasEnergy.at(1) < 525.0 )
					{	
						plot(MTAS_POSITION_ENERGY+482, maxSiliconSignal );
					}
				}		
						
				if( totalMtasEnergy.at(1) > 495.0 && totalMtasEnergy.at(1) < 525.0 )
				{	
					plot(MTAS_POSITION_ENERGY+481, maxSiliconSignal );
				}
			}
